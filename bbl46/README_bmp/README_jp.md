...
| [BLE Micro Pro用電池基板](https://shop.yushakobo.jp/products/ble-micro-pro-battery-board/) | 1 |
| コイン電池 CR1632  | 2 |
...
#### S4ショットキーダイオード のはんだ付け (1/4)

<img src="./images/bmp_handa_part01_state01.jpg" width="320px">

1. S4ショットキーダイオード を PCB にはんだ付けする
    * 取り付け位置は D91とD92

    1. 部品を載せる前に、2つある■( `[■ ▷| ■]` )の片側に予備はんだを盛る  
       ※ はんだごてを持つ手側の■に盛るとよいです  
    1. S4ショットキーダイオード の片足を予備はんだと接合する  
       ※ ダイオードに印字されている `|` と`[■ ▷| ■]` の `▷|` を合わせてください  
    1. S4ショットキーダイオード が基板から浮いていないことを確認する  
    1. S4ショットキーダイオード の未接合の足をはんだ付けする
    1. S4ショットキーダイオード が基板から浮いていないことを確認する
