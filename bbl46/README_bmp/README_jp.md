...
BMPを bbl46 のマイコンとして利用可能な状態とするために、大きくわけて以下の作業が必要です。

1. BMP をアップデートする
1. BMP に bbl46 専用コンフィグを投入する
