...
1. 支柱に $porond_nn を貼り付ける
    1. 使用する支柱を選ぶ
        * 肉抜きのない支柱と肉抜きのある支柱がそれぞれ10本ずつ (短4本+長6本) から、  
          $cased_nn の10箇所のくぼみに取り付けるか決める  
          {{ 画像 }}
        * 参考
            * 1,2,3,4: $ps1_nn + 5,6,7,8,9,10: $pl1_nn
            * 1,4: $ps2_nn + 2,3: $ps1_nn + 5,6,7,10: $pl2_nn + 8,9: $pl1_nn
            * 2,3: $ps2_nn + 5,6,8,9: $pl2_nn
